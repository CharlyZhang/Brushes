...
//        self.imageView.transform = CGAffineTransformTranslate(self.imageView.transform, loc.x, loc.y-64);
        
        CGAffineTransform tX = CGAffineTransformIdentity;
//        tX = CGAffineTransformTranslate(tX, loc.x, -loc.y);
        self.imageTransform = CGAffineTransformConcat(self.imageView.transform, tX);
